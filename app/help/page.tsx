            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <ul className="text-[var(--muted)] list-disc ml-4 mt-1 space-y-1">
                  ...
                  <li><span className="text-white">Matrix</span> — Your tasks sorted into Do Now, Schedule, Fit In and Backburner by importance and urgency, as four lists with a Plan button on each; switch to Chart for the scatter view.</li>
                  <li>Every task has a <span className="text-white">📅 Plan</span> button: a day picker showing what the coming days already hold. It is how you plan on a phone, where dragging does not work.</li>
                </ul>
              </div>
            </div>
            <div className="flex gap-4">
